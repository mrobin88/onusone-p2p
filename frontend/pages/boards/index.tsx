...
const mockBoards: Board[] = [
  {
    ...
    description: 'Open discussions about anything and everything in our P2P network. The heart of our decentralized community.',
    category: 'General',
    messageCount: 324,
  ...
  },
  {
    ...
    slug: 'technology',
    name: 'Technology',
    description: 'Tech discussions, programming, AI, blockchain, and P2P innovations. Share your technical insights.',
    category: 'Technology',
    messageCount: 156,
  ...
  },
  {
    ...
    slug: 'community',
    name: 'Community',
    description: 'Community governance, network improvements, and collaboration. Shape the future of our P2P platform.',
    category: 'Community',
    messageCount: 89,
  ...
  },
  {
    ...
    description: 'Technical discussions about P2P protocols, IPFS, libp2p, and network architecture improvements.',
  ...
  },
  {
    ...
    description: 'Discuss reputation systems, content decay algorithms, and decentralized network governance.',
    category: 'Governance',
    messageCount: 45,
  ...
  },
  {
    ...
    slug: 'newcomers',
    name: 'Newcomers Hub',
    description: 'New to P2P? Get help setting up your node, understanding the network, and making your first contributions.',
    category: 'Support',
    messageCount: 78,
