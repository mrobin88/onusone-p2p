...
export const P2P_CONFIG = {
  ...
  BOOTSTRAP_NODES: [
    process.env.NEXT_PUBLIC_P2P_BACKEND_URL || 'https://onusone-p2p-unified.onrender.com',
  ...
  // WebSocket endpoints
  WEBSOCKET_ENDPOINTS: [
    (process.env.NEXT_PUBLIC_P2P_BACKEND_URL || 'https://onusone-p2p-unified.onrender.com').replace('http://', 'ws://').replace('https://', 'wss://'),
